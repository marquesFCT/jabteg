...
public class DefaultTraceReader implements Serializable, TraceReader {
    ...
    protected int readPaths() {
        ...
        do { // Le cada uma das linhas do arquivo de trace
        	try 
        	{
		       	...
		       	{ // precisa criar uma nova entrada na hashtable pois o registro �
		       	  // de um novo metodo
		       		if (lastNode != null )
		       		{
    ...
    protected String getNoFromRegistro(String registro) {
		// N� aparece como �ltimo campo no registro
	 ...
	 * @param registro - string com informa�oes do arquivo de traca
