...
public class ProberInstrum {
	 ...
	 * @return OK?
	 */
        private static InstrumentClass[] _classes;   
        
        public static InstrumentClass[] getInstrumentedClassesInfo()
        {
            return _classes;
        }
	...
	public static boolean instrumentProgram(Program program,
		...
		try {
			mp = dpi.instrument(CFGOption);
                        ...
                        // Captura os dados coletados durante a instrumentação
                        // Captura os métodos das classes e seus respectivos nós
                        _classes = dpi.getInstrumentClasses();
