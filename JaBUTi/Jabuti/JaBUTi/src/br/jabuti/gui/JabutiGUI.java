...
public class JabutiGUI extends JFrame {
	...
	private ProbeCheck probeCheck = null;
        ...
        // Criar instância do contrutor de menus de AGDTPOO
        private  br.jabuti.agdtpoo.MenuBuilder menuBuilder = new br.jabuti.agdtpoo.MenuBuilder();
	...
	private void disableDefaultOptions() {
		...
		testServerProperty.setEnabled(false);
                ...
                // AGDTPOO - Disabled Menu
                menuBuilder.disabledMenu();
	}
		...
		try {
			...
			jbtProject
					.setCFGOption((cfgOptionCheckBox.isSelected()) ? CFG.NO_CALL_NODE
                        ...
                        menuBuilder.setJabutiProject(jbtProject);
		} catch (Exception e) {
...
//		menuBar.add(qualipsoMenu);
	...
	private void buildSummaryMenu() {
        ...
        // Fernando Henrique - AGDTPOO
        private void buildAGDTPOOMenu() {
           
            // Contruir menu
            menuBuilder.buildTestDataGenerationMenu(menuBar, this.jbtProject);            
	}
