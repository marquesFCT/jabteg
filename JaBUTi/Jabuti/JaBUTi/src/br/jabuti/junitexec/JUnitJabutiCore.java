...
public class JUnitJabutiCore {
	...
	static public void runInstrumenting(String classpath, String ts,
        ...
        static public Result runInstrumentingWithResult(String classpath, String ts,
			String trace, Set<String> testSet, PrintStream ps)
			throws ClassNotFoundException, MalformedURLException,
			InstantiationException, IllegalAccessException, SecurityException,
			NoSuchMethodException, IllegalArgumentException,
		...
		org.junit.runner.Result res = juc.run(clazz);
	...
	static public void usage() {
		System.out.println("JUnitJabutiCore [-trace <file_name>] -cp <test_set_classpath> -tcClass <test_class> [<test_case_name1> <test_case_name2>...]");
	}
}